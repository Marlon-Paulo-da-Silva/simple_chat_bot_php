        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="https://sandbox.imobibrasil.app.br/imobiliarias/libs/widget-chat/chat_bot_atendimento/uploads/imobibrasil.png" alt="User Avatar" class="img-size-50 mr-3 img-circle">
