...
<div class="col-lg-12">
	<div class="card card-outline rounded-0 card-navy">
		...
		<div class="card-body">
            ...
            < ?php endif; ?> -->
			<fieldset>
				<legend>ChatBot Defaults</legend>
				<div class="form-group">
					<label for="" class="control-label">ChatBot Name</label>
					<input name="bot_name" id="" cols="30" class="form-control" value="<?= $_settings->info('bot_name') ?>">
				</div>
				<div class="form-group">
					<label for="" class="control-label">Welcome Message</label>
					<textarea name="welcome_message" id="" cols="30" rows="2" class="form-control summernote"><?= $_settings->info('welcome_message') ?></textarea>
				</div>
				<div class="form-group">
					<label for="" class="control-label">No Answer Response</label>
					<textarea name="no_answer" id="" cols="30" rows="2" class="form-control summernote"><?= $_settings->info('no_answer') ?></textarea>
				</div>
				<?php 
				$suggestions = $_settings->info('suggestion') != "" ? json_decode($_settings->info('suggestion')): [];
				?>
				<div class="form-group">
					<label for="" class="control-label">Suggestion 1</label>
					<input name="suggestion[]" id="" cols="30" class="form-control" value="<?= isset($suggestions[0]) ? $suggestions[0] : '' ?>">
				</div>
				<div class="form-group">
					<label for="" class="control-label">Suggestion 2</label>
					<input name="suggestion[]" id="" cols="30" class="form-control" value="<?= isset($suggestions[1]) ? $suggestions[1] : '' ?>">
				</div>
				<div class="form-group">
					<label for="" class="control-label">Suggestion 3</label>
					<input name="suggestion[]" id="" cols="30" class="form-control" value="<?= isset($suggestions[2]) ? $suggestions[2] : '' ?>">
				</div>
			</fieldset>
			</form>
		</div>
