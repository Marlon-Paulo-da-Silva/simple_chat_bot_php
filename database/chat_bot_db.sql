...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Maio-2023 às 06:21
...
(1, 'Boa tarde'),
(1, 'Boa noite'),
(9, 'Como colocar meu site no ar?'),
(9, 'Quero colocar o site no ar'),
(9, 'Site no ar');
...
(1, 'Oi, bem vindo à imobibrasil', 1, '2022-05-05 10:30:35', '2023-05-04 21:59:16'),
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `email`, `password`, `avatar`, `last_login`, `type`, `active`, `date_added`, `date_updated`) VALUES
